...
const Cadastro = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    if (result?.error) {
      toast({
        title: "Erro no cadastro",
        description: result.error.message || "Não foi possível fazer cadastro com Google. Tente novamente.",
        variant: "destructive",
      });
      setIsLoading(false);
    }
        ...
        <div className="bg-card rounded-3xl shadow-medium p-8 md:p-10 glass-card">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-muted-foreground text-sm mt-1 text-center">
              Crie sua conta gratuitamente e comece a ganhar
            </p>
          </div>

          {/* Social Login - Only Google (configured) */}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="chavePix" className="text-foreground font-medium">
                  Chave PIX
                </Label>
                <div className="relative">
